...
public class TaskFacadeEjbTest extends BaseBeanTest {
	...
	@Test
	public void testTaskDashboardDtoListCreation() {
		...
		List<TaskDashboardDto> dashboardDtos = taskFacade.getAllWithDueDateBetween(new Date(), DateHelper.addDays(new Date(), 2), user.getUuid());
