...
public class PathogenTestFacadeEjbPseudonymizationTest extends AbstractBeanTest {
	...
	public void testPathogenTestOnSampleInJurisdiction() {
		...
		PathogenTestDto pathogenTest = creator.createPathogenTest(sample.toReference(), PathogenTestType.ISOLATION, Disease.CORONAVIRUS, new Date(),
				lab, user2.toReference(), PathogenTestResultType.PENDING, "", true);
	...
	public void testPathogenTestOnSampleOutsideJurisdiction() {
		...
		PathogenTestDto pathogenTest = creator.createPathogenTest(sample.toReference(), PathogenTestType.ISOLATION, Disease.CORONAVIRUS, new Date(),
				lab, user1.toReference(), PathogenTestResultType.PENDING, "", true);
	...
	public void testPseudonymizeGetAllActive() {
		...
		PathogenTestDto pathogenTest1 = creator.createPathogenTest(sample1.toReference(), PathogenTestType.ISOLATION, Disease.CORONAVIRUS, new Date(),
				lab1, user2.toReference(), PathogenTestResultType.PENDING, "", true);
		...
		PathogenTestDto pathogenTest2 = creator.createPathogenTest(sample2.toReference(), PathogenTestType.ISOLATION, Disease.CORONAVIRUS, new Date(),
				lab2, user1.toReference(), PathogenTestResultType.PENDING, "", true);
