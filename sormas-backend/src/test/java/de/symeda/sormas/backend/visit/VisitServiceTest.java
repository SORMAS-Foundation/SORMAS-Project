...
public class VisitServiceTest extends AbstractBeanTest {
	...
	public void testGetAllRelevantVisits() {
		...
		Date startDate3 = DateHelper.subtractDays(new Date(), CaseLogic.ALLOWED_CASE_DATE_OFFSET * 2);
		...
		visit4.setVisitDateTime(DateHelper.subtractDays(startDate, CaseLogic.ALLOWED_CASE_DATE_OFFSET + 1));
		...
		visit4.setVisitDateTime(DateHelper.subtractDays(startDate3, CaseLogic.ALLOWED_CASE_DATE_OFFSET));
		getVisitFacade().saveVisit(visit4);
		...
		visit4.setVisitDateTime(DateHelper.addDays(endDate3, CaseLogic.ALLOWED_CASE_DATE_OFFSET + 1));
		getVisitFacade().saveVisit(visit4);
		...
		visit4.setVisitDateTime(DateHelper.addDays(endDate, CaseLogic.ALLOWED_CASE_DATE_OFFSET));
		getVisitFacade().saveVisit(visit4);
