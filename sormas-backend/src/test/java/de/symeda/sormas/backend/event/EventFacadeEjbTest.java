...
public class EventFacadeEjbTest extends AbstractBeanTest {
	...
	public void testArchiveOrDearchiveEvent() {
		...
		getEventFacade().archiveCoreEntities(Collections.singletonList(event.getUuid()), null);
		...
		getEventFacade().dearchiveCoreEntities(Collections.singletonList(event.getUuid()), null);
	...
	public void testArchiveAllArchivableEvents() {
		...
		cut.archiveCoreEntities(Collections.singletonList(event1.getUuid()), null);
