...
public class CampaignFormFacadeEjbTest extends AbstractBeanTest {
	...
	@Test
	public void testSaveCampaignForm() throws IOException {
		// ID is required
		String schema = "[{\"type\": \"string\"}]";
		CampaignFormDto campaignForm = getCampaignFormFacade().buildCampaignFormFromJson("testForm", null, schema);

		try {
			getCampaignFormFacade().saveCampaignForm(campaignForm);
		...
		// Type is required
		schema = "[{\"id\": \"element\"}]";
		campaignForm = getCampaignFormFacade().buildCampaignFormFromJson("testForm", null, schema);
		...
		try {
			...
			getCampaignFormFacade().buildCampaignFormFromJson("testForm", null, schema);
