...
public class CaseClassificationLogicTest extends AbstractBeanTest {
	...
	public void testAutomaticClassificationForEVD() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.EVD), false);
	...
	public void testAutomaticClassificationForCSM() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.CSM), false);
	...
	public void testAutomaticClassificationForLassa() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.LASSA), false);
	...
	public void testAutomaticClassificationForYellowFever() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildConfirmedCaseBasis(Disease.YELLOW_FEVER), false);
	...
	public void ruleOutFalsePositivesForYellowFever() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.YELLOW_FEVER), false);
		createSampleTestsForAllTestTypesExcept(
			caze,
	...
	public void testAutomaticClassificationForDengueFever() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.DENGUE), false);
	...
	public void testAutomaticClassificationForNewFlu() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.NEW_INFLUENZA), false);
	...
	public void testAutomaticClassificationForMeasles() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.MEASLES), false);
	...
	public void testAutomaticClassificationForCholera() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.CHOLERA), false);
	...
	public void testAutomaticClassificationForMonkeypox() {
		...
		// Confirmed
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.MONKEYPOX), false);
	...
	public void testAutomaticClassificationForPlague() {
		...
		// Probable
		caze = getCaseFacade().saveCase(buildSuspectCase(Disease.PLAGUE), false);
	...
	private CaseDataDto buildSuspectCaseBasis(Disease disease) {
		...
		case MONKEYPOX:
			...
			break;
		case LASSA:
			caze.getEpiData().getExposures().add(creator.buildAnimalContactExposure(TypeOfAnimal.RODENT));
			break;
		case MEASLES:
			caze.getSymptoms().setFever(SymptomState.YES);
			caze.getSymptoms().setSkinRash(SymptomState.YES);
