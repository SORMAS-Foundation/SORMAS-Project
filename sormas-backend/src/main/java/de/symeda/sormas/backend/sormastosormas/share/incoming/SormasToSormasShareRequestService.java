...
public class SormasToSormasShareRequestService extends AdoServiceWithUserFilterAndJurisdiction<SormasToSormasShareRequest> {
	...
	@Override
	public Predicate createUserFilterForObsoleteSync(CriteriaBuilder cb, CriteriaQuery cq, From<?, SormasToSormasShareRequest> from) {
		return null;
	}

	@Override
	protected Predicate createLimitedChangeDateFilter(CriteriaBuilder cb, From<?, SormasToSormasShareRequest> from) {
		return null;
	}

	@Override
	protected Predicate createLimitedChangeDateFilterForObsoleteEntities(CriteriaBuilder cb, From<?, SormasToSormasShareRequest> from) {
		return null;
	}
	...
	public List<String> getAllNonRefferencedSormasToSormasShareRequest() {
		...
		cq.where(
			cb.and(
				cb.not(cb.equal(root.get(SormasToSormasShareRequest.STATUS), ShareRequestStatus.PENDING)),
