...
public class StartupConfigurationValidationService {
	...
	public void validateAppUrls() {
		...
		String appLegacyUrl = configFacade.getAsString(Config.APP_LEGACY_URL).orElse(null);
	...
	private @Nullable String getAppUrl() {
		return configFacade.getAsString(Config.APP_URL).orElse(null);
	}
	...
	public void validateConfigUrls() {
		...
		String geocodingUrl = configFacade.getGeocodingServiceUrlTemplate();
		...
		String mapTilersUrl = configFacade.getMapTilersUrl();
