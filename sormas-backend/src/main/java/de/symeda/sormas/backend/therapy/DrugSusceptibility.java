...
public class DrugSusceptibility extends AbstractDomainObject {
	...
	public static final String PATHOGENTEST_ID = "pathogenTestId";
	...
	@JoinColumn(name = "pathogentest_id")
	...
	@Column(name = "pathogentest_id", insertable = false, updatable = false)
	public Long getPathogenTestId() {
		return pathogenTestId;
	}

	public void setPathogenTestId(Long pathogenTestId) {
		this.pathogenTestId = pathogenTestId;
	}
