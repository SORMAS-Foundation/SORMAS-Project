...
import de.symeda.sormas.backend.user.UserCache;
...
public abstract class AbstractDomainObject implements Serializable, Cloneable, HasUuid {
    ...
    static class AdoListener {
        ...
        private User getCurrentUser() {
            try {
                CurrentUserService currentUserService = (CurrentUserService) new InitialContext().lookup("java:global/sormas-ear/sormas-backend/CurrentUserService");
