...
public class ProcessedDataPersisterHelper {
	...
	public <T extends SormasToSormasEntityDtoInterface, U extends SormasToSormasEntityDtoInterface> void sharedAssociatedEntityCallback(U parent, T entity) {
	...
	public static class ReturnedAssociatedEntityCallback {
		...
		public <T extends HasUuid & SormasToSormasEntityDtoInterface> void apply(T entity, BiFunction<String, String, SormasToSormasShareInfo> findShareInfo) {
