...
public class PrescriptionFacadeEjb implements PrescriptionFacade {
	...
	@Override
	public List<PrescriptionDto> getAllActivePrescriptionsAfter(Date date, Integer batchSize, String lastUuid) {
		...
		return service.getAllActivePrescriptionsAfter(date, user, batchSize, lastUuid)
			.stream()
