...
//		return null;
	...
	@Override
	public DiseaseBurdenDto getDiseaseGridForDashboard(RegionReferenceDto regionRef, DistrictReferenceDto districtRef, Disease disease, Date from, Date to, Date previousFromDate, Date previousToDate) {
		return null;
	}
