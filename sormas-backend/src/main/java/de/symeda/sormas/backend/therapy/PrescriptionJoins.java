...
public class PrescriptionJoins extends AbstractDomainObjectJoins<Prescription, Prescription> {
	private Join<Prescription, Therapy> therapy;
	...
	public PrescriptionJoins(From<Prescription, Prescription> root) {
		super(root);
	}

	public Join<Prescription, Therapy> getTherapy() {
		return getOrCreate(therapy, Prescription.THERAPY, JoinType.LEFT, this::setTherapy);
	}

	private void setTherapy(Join<Prescription, Therapy> therapy) {
