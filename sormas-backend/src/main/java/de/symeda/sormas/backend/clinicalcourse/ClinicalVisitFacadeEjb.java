...
public class ClinicalVisitFacadeEjb implements ClinicalVisitFacade {
	...
	@Override
	public List<ClinicalVisitDto> getAllActiveClinicalVisitsAfter(Date date, Integer batchSize, String lastUuid) {
		...
		return service.getAllActiveClinicalVisitsAfter(date, batchSize, lastUuid)
			.stream()
