...
public class TreatmentFacadeEjb implements TreatmentFacade {
	...
	@Override
	public List<TreatmentDto> getAllActiveTreatmentsAfter(Date date, Integer batchSize, String lastUuid) {
		...
		return service.getAllActiveTreatmentsAfter(date, user, batchSize, lastUuid)
			.stream()
