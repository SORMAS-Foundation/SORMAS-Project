...
public class SymptomsFacadeEjb implements SymptomsFacade {
	...
	public Symptoms fillOrBuildEntity(SymptomsDto source, Symptoms target, boolean checkChangeDate) {
		...
		target.setStillbornInfant(source.getStillbornInfant());
		target.setUnknownClinicalPresentation(source.getUnknownClinicalPresentation());
		target.setNeurologicalComplications(source.getNeurologicalComplications());
		target.setLowBirthWeight(source.getLowBirthWeight());
		target.setHepatitis(source.getHepatitis());
		target.setThrombocytopenicPurpura(source.getThrombocytopenicPurpura());
		target.setRubellaArthritis(source.getRubellaArthritis());
		target.setGreggsTriad(source.getGreggsTriad());
		...
		target.setUrethritis(source.getUrethritis());
		target.setGonococcalInfectionSiteAnorectal(source.getGonococcalInfectionSiteAnorectal());
		target.setGonococcalInfectionSiteBlood(source.getGonococcalInfectionSiteBlood());
		target.setGonococcalInfectionSiteCerebrospinalFluid(source.getGonococcalInfectionSiteCerebrospinalFluid());
		target.setGonococcalInfectionSiteEye(source.getGonococcalInfectionSiteEye());
		target.setGonococcalInfectionSiteGenital(source.getGonococcalInfectionSiteGenital());
		target.setGonococcalInfectionSiteJointFluid(source.getGonococcalInfectionSiteJointFluid());
		target.setGonococcalInfectionSitePharyngeal(source.getGonococcalInfectionSitePharyngeal());
		target.setGonococcalInfectionSiteUnknown(source.getGonococcalInfectionSiteUnknown());
		target.setGonococcalInfectionSiteOther(source.getGonococcalInfectionSiteOther());
		target.setGonococcalInfectionSiteOtherText(source.getGonococcalInfectionSiteOtherText());
		target.setNoConcurrentSti(source.getNoConcurrentSti());
		target.setConcurrentStiChlamydia(source.getConcurrentStiChlamydia());
		target.setConcurrentStiGenitalHerpes(source.getConcurrentStiGenitalHerpes());
		target.setConcurrentStiLgv(source.getConcurrentStiLgv());
		target.setConcurrentStiMycoplasmaGenitalium(source.getConcurrentStiMycoplasmaGenitalium());
		target.setConcurrentStiInfectiousSyphilis(source.getConcurrentStiInfectiousSyphilis());
		target.setConcurrentStiTrichomonasVaginalis(source.getConcurrentStiTrichomonasVaginalis());
		target.setConcurrentStiGenitalWarts(source.getConcurrentStiGenitalWarts());
		target.setConcurrentStiOther(source.getConcurrentStiOther());
		target.setConcurrentStiOtherText(source.getConcurrentStiOtherText());
		target.setConcurrentStiUnknown(source.getConcurrentStiUnknown());
