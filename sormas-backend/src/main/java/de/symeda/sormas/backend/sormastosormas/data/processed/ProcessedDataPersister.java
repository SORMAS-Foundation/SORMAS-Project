...
public abstract class ProcessedDataPersister<T extends SormasToSormasEntityDtoInterface, S extends de.symeda.sormas.api.sormastosormas.SormasToSormasEntityDto<T>, E extends SormasToSormasEntity> {
