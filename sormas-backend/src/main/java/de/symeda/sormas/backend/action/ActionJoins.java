...
public class ActionJoins extends AbstractDomainObjectJoins<Action, Action> {
	...
	private Join<Action, User> lastModifiedByUser;
	...
	public Join<Action, User> getLastModifiedByUser() {
		return getOrCreate(creator, Action.LAST_MODIFIED_BY_USER, JoinType.LEFT, this::setLastModifiedByUser);
	}

	private void setLastModifiedByUser(Join<Action, User> lastModifiedByUser) {
