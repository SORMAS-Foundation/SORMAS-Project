...
public class ClinicalVisitService extends AdoServiceWithUserFilter<ClinicalVisit> {
	...
	public List<ClinicalVisit> getAllActiveClinicalVisitsAfter(Date date, Integer batchSize, String lastUuid) {
	...
	private Predicate createChangeDateFilter(CriteriaBuilder cb, From<?, ClinicalVisit> clinicalVisits, Timestamp date, String lastUuid) {
		...
		ChangeDateFilterBuilder changeDateFilterBuilder =
			lastUuid == null ? new ChangeDateFilterBuilder(cb, date) : new ChangeDateFilterBuilder(cb, date, clinicalVisits, lastUuid);
