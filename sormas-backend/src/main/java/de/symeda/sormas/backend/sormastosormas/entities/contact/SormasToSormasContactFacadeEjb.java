...
public class SormasToSormasContactFacadeEjb extends AbstractSormasToSormasInterface<Contact, ContactDto, SormasToSormasContactDto, ContactService>
	...
	public String getRequestEndpoint() {
		return CONTACT_REQUEST_ENDPOINT;
	}

	@Override
	public String getRequestGetDataEndpoint() {
		return CONTACT_REQUEST_GET_DATA_ENDPOINT;
	}

	@Override
	public String getSaveEndpoint() {
		return SAVE_SHARED_CONTACT_ENDPOINT;
	}

	@Override
	public String getSyncEndpoint() {
		return SYNC_SHARED_CONTACT_ENDPOINT;
	}

	@Override
	public String getSharesEndpoint() {
		return CONTACT_SHARES_ENDPOINT;
	}

	@Override
	public String getEntityCaptionTag() {
		return Captions.Contact;
	}

	@Override
	public ShareRequestDataType getShareRequestDataType() {
		return ShareRequestDataType.CONTACT;
	}
	...
	@Override
	public SormasToSormasShareInfo getByTypeAndOrganization(Contact ado, String targetOrganizationId) {
		return shareInfoService.getByContactAndOrganization(ado.getUuid(), targetOrganizationId);
	}

	@Override
	protected ValidationErrorGroup buildValidationGroupNameForAdo(Contact ado) {
		return buildContactValidationGroupName(ado);
	}
	...
	public static class SormasToSormasContactFacadeEjbLocal extends SormasToSormasContactFacadeEjb {
		...
		public SormasToSormasContactFacadeEjbLocal() {
		}
