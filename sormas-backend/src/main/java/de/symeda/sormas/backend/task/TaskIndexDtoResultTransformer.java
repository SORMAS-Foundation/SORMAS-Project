...
public class TaskIndexDtoResultTransformer implements ResultTransformer {

	private static final long serialVersionUID = -256528439589310194L;

	@Override
	public TaskIndexDto transformTuple(Object[] tuple, String[] aliases) {
		int index = -1;

		//@formatter:off
        return new TaskIndexDto(
                (String) tuple[++index], (TaskContext) tuple[++index], (String) tuple[++index], (String) tuple[++index], (String) tuple[++index],
