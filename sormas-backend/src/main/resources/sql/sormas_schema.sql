...
-- 2020-03-02 Add zip code to location #1553
ALTER TABLE location ADD COLUMN zipcode varchar(512);
ALTER TABLE location_history ADD COLUMN zipcode varchar(512);

INSERT INTO schema_version (version_number, comment) VALUES (182, 'Add zip code to location #1553');