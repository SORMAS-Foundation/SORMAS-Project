...
ALTER TABLE person ADD COLUMN additionaldetails varchar(4096);
ALTER TABLE person_history ADD COLUMN additionaldetails varchar(4096);
INSERT INTO schema_version (version_number, comment) VALUES (363, 'Add additional details to person #3936');
