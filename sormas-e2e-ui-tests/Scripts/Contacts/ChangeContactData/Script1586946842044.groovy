...
WebUI.click(findTestObject('Contacts/ContactInformationView/ChangeContactData/td_Auto1'))
...
WebUI.click(findTestObject('Contacts/ContactInformationView/ChangeContactData/td_Autodist'))

WebUI.scrollToElement(findTestObject('Contacts/ContactInformationView/ChangeContactData/div_Relationship with case_v-filterselect-button'), 
    2)
...
WebUI.scrollToElement(findTestObject('Contacts/ContactInformationView/ChangeContactData/textarea_Follow-up status comment_followUpComment'), 
    1)
...
String region = WebUI.getAttribute(findTestObject('Contacts/ContactInformationView/ChangeContactData/input_Responsible region'), 
    'value')

String district = WebUI.getAttribute(findTestObject('Contacts/ContactInformationView/ChangeContactData/input_Responsible district'), 
    'value')

if (!(region.equalsIgnoreCase('Auto1')) || !(district.equalsIgnoreCase('Autodist'))) {
    WebUI.closeBrowser()

    throw new StepFailedException((('The region and/or district should equal "Auto1". region: ' + region) + ' district:') + 
    district)
}

String relation = WebUI.getAttribute(findTestObject('Contacts/ContactInformationView/ChangeContactData/input_Relationship with case'), 
    'value')
...
String contactDescription = WebUI.getAttribute(findTestObject('Contacts/ContactInformationView/ChangeContactData/textarea_Description of how contact took place'), 
    'value')
...
String quarantine = WebUI.getAttribute(findTestObject('Contacts/ContactInformationView/ChangeContactData/input_Quarantine'), 
    'value')
...
String comment = WebUI.getAttribute(findTestObject('Contacts/ContactInformationView/ChangeContactData/textarea_Follow-up status comment_followUpComment'), 
    'value')
