		...
		FlowThen<ExternalMessageProcessingResult> caseFlow = flow.then(previousResult -> {
			...
			return mismatchInformationStage.thenCompose(confirmed -> {
				if (Boolean.TRUE.equals(confirmed)) {
					CaseDataDto selectedCase = prepareSelectedCase(caze, getExternalMessage());
					ExternalMessageProcessingResult withCase = previousResult.getData().withSelectedCase(selectedCase);
