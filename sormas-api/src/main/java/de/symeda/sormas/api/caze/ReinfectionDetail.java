...
public enum ReinfectionDetail {
	...
	GENOME_COPY_NUMBER_ABOVE_THRESHOLD(ReinfectionDetailGroup.PRECEDING_INFECTION),
	GENOME_COPY_NUMBER_BELOW_THRESHOLD(ReinfectionDetailGroup.PRECEDING_INFECTION),
	ACUTE_RESPIRATORY_ILLNESS_OVERCOME(ReinfectionDetailGroup.REINFECTION_EVALUATION),
	PREVIOUS_ASYMPTOMATIC_INFECTION(ReinfectionDetailGroup.REINFECTION_EVALUATION),
