...
public interface ShareRequestInfoFacade {
	...
	List<ShareRequestIndexDto> getIndexList(ShareRequestCriteria criteria, Integer offset, Integer size, List<SortProperty> sortProperties);

	long count(ShareRequestCriteria criteria);

	ShareRequestDetailsDto getShareRequestDetails(String requestUuid);
}
