...
public interface AefiDashboardFacade {
	...
	Map<AefiInvestigationStatus, Map<String, String>> getAefiInvestigationCountsByInvestigationStatus(AefiDashboardCriteria dashboardCriteria);

	Map<AefiClassification, Map<String, String>> getAefiInvestigationCountsByAefiClassification(AefiDashboardCriteria dashboardCriteria);
