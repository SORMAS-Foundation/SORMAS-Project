...
public class ContactIndexDetailedDto extends ContactIndexDto {
	...
	public ContactIndexDetailedDto(String uuid, String personFirstName, String personLastName, String cazeUuid, Disease disease, String diseaseDetails,
								   ...
								   String reportingUserFirstName, String reportingUserLastName, Long id, Date creationDate, Float completeness, int visitCount
	) {
	//@formatter:on
		...
		super(uuid, personFirstName, personLastName, cazeUuid, disease, diseaseDetails, caseFirstName, caseLastName, regionUuid, regionName, districtUuid, districtName, communityUuid,
				...
				caseReportingUserUid, caseRegionUuid, caseRegionName, caseDistrictUuid, caseDistrictName, caseCommunityUuid, caseHealthFacilityUuid, casePointOfEntryUuid, changeDate, externalID, externalToken, id, creationDate, completeness, visitCount);
		//@formatter:on
