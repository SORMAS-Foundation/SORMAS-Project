...
public class CaseClassificationValidator {
	...
	public static boolean isValidCaseClassification(CaseClassification caseClassification, CaseDataDto caseDataDto) {
	...
	private static boolean positiveLabResult(CaseDataDto caseDataDto) {
