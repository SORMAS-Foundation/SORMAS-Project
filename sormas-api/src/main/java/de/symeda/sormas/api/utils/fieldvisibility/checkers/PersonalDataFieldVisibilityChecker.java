...
public class PersonalDataFieldVisibilityChecker implements FieldVisibilityCheckers.FieldBasedChecker {
	private final RightCheck rightCheck;
	private final boolean isInJurisdiction;

	public PersonalDataFieldVisibilityChecker(RightCheck rightCheck, boolean isInJurisdiction) {
	...
	public boolean isVisible(Field field) {
		...
		return !field.isAnnotationPresent(PersonalData.class) ||
				rightCheck.check(personalDataRight);
	}
