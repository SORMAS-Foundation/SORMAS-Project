...
public class SpecialCaseAccessDto extends EntityDto {
	...
	public SpecialCaseAccessDto withCase(CaseReferenceDto caze) {
		SpecialCaseAccessDto withCase = build(caze, assignedBy);
		withCase.setAssignedTo(assignedTo);
		withCase.setEndDateTime(endDateTime);
		withCase.setAssignmentDate(assignmentDate);
