			...
			changedFields.addAll(
				map(
					Stream.of(
						...
						Mapping.of(pathogenTest::setPorBAllele, pathogenTest.getPorBAllele(), sourceTestReport.getPorBAllele(), PathogenTestDto.POR_B_ALLELE),
						Mapping.of(pathogenTest::setTbpBAllele, pathogenTest.getTbpBAllele(), sourceTestReport.getTbpBAllele(), PathogenTestDto.TBP_B_ALLELE),
						Mapping.of(pathogenTest::setSequenceType, pathogenTest.getSequenceType(), sourceTestReport.getSequenceType(), PathogenTestDto.SEQUENCE_TYPE),
						Mapping.of(pathogenTest::setGenogroup, pathogenTest.getGenogroup(), sourceTestReport.getGenogroup(), PathogenTestDto.GENOGROUP),
						Mapping.of(
						...
						Mapping.of(pathogenTest.getDrugSusceptibility()::setCefiximeMethod, pathogenTest.getDrugSusceptibility().getCefiximeMethod(), sourceTestReport.getCefiximeMethod(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.CEFIXIME_METHOD),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setCefiximeMic, pathogenTest.getDrugSusceptibility().getCefiximeMic(), sourceTestReport.getCefiximeMic(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.CEFIXIME_MIC),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setCefiximeSusceptibility, pathogenTest.getDrugSusceptibility().getCefiximeSusceptibility(), sourceTestReport.getCefiximeSusceptibility(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.CEFIXIME_SUSCEPTIBILITY),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setTetracyclineMethod, pathogenTest.getDrugSusceptibility().getTetracyclineMethod(), sourceTestReport.getTetracyclineMethod(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.TETRACYCLINE_METHOD),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setTetracyclineMic, pathogenTest.getDrugSusceptibility().getTetracyclineMic(), sourceTestReport.getTetracyclineMic(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.TETRACYCLINE_MIC),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setTetracyclineSusceptibility, pathogenTest.getDrugSusceptibility().getTetracyclineSusceptibility(), sourceTestReport.getTetracyclineSusceptibility(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.TETRACYCLINE_SUSCEPTIBILITY),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setGentamicinMethod, pathogenTest.getDrugSusceptibility().getGentamicinMethod(), sourceTestReport.getGentamicinMethod(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.GENTAMICIN_METHOD),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setGentamicinMic, pathogenTest.getDrugSusceptibility().getGentamicinMic(), sourceTestReport.getGentamicinMic(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.GENTAMICIN_MIC),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setGentamicinSusceptibility, pathogenTest.getDrugSusceptibility().getGentamicinSusceptibility(), sourceTestReport.getGentamicinSusceptibility(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.GENTAMICIN_SUSCEPTIBILITY),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setSpectinomycinMethod, pathogenTest.getDrugSusceptibility().getSpectinomycinMethod(), sourceTestReport.getSpectinomycinMethod(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.SPECTINOMYCIN_METHOD),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setSpectinomycinMic, pathogenTest.getDrugSusceptibility().getSpectinomycinMic(), sourceTestReport.getSpectinomycinMic(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.SPECTINOMYCIN_MIC),
						Mapping.of(pathogenTest.getDrugSusceptibility()::setSpectinomycinSusceptibility, pathogenTest.getDrugSusceptibility().getSpectinomycinSusceptibility(), sourceTestReport.getSpectinomycinSusceptibility(), PathogenTestDto.DRUG_SUSCEPTIBILITY, DrugSusceptibilityDto.SPECTINOMYCIN_SUSCEPTIBILITY),
