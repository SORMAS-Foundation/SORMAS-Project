...
public enum UserRight {
	...
	CAMPAIGN_VIEW(ADMIN, NATIONAL_USER, SURVEILLANCE_SUPERVISOR, SURVEILLANCE_OFFICER, CASE_SUPERVISOR, CASE_OFFICER,
			CONTACT_SUPERVISOR, CONTACT_OFFICER, EVENT_OFFICER,
			POE_SUPERVISOR),
	CAMPAIGN_EDIT(ADMIN, NATIONAL_USER),
	CAMPAIGN_ARCHIVE(ADMIN, NATIONAL_USER),
