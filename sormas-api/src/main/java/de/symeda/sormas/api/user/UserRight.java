...
public enum UserRight {
	...
	// TODO DOCUMENT_DELETE, TASK_DELETE, SAMPLE_DELETE, VISIT_DELETE, PERSON_DELETE, TREATMENT_DELETE, PRESCRIPTION_DELETE, CLINICAL_VISIT_DELETE and IMMUNIZATION_DELETE
	CASE_DELETE(UserRightGroup.CASE, UserRight._CASE_VIEW, UserRight._SAMPLE_DELETE),
	 ...
	 */
	CASE_INVESTIGATE(UserRightGroup.CASE, UserRight._CASE_VIEW),
	/*
	 * Edit the classification and outcome of a case
	 */
	CASE_CLASSIFY(UserRightGroup.CASE, UserRight._CASE_VIEW),
	CASE_CHANGE_DISEASE(UserRightGroup.CASE, UserRight._CASE_VIEW),
	CASE_CHANGE_EPID_NUMBER(UserRightGroup.CASE, UserRight._CASE_EDIT),
	CASE_TRANSFER(UserRightGroup.CASE, UserRight._CASE_VIEW),
	CASE_REFER_FROM_POE(UserRightGroup.CASE, UserRight._CASE_VIEW),
	CASE_MERGE(UserRightGroup.CASE, UserRight._CASE_VIEW, UserRight._CASE_EDIT),
	CASE_SHARE(UserRightGroup.CASE, UserRight._CASE_VIEW),
	CASE_RESPONSIBLE(UserRightGroup.CASE, UserRight._CASE_VIEW),
	...
	// TODO ACTION_DELETE
	PERSON_DELETE(UserRightGroup.PERSON, UserRight._PERSON_VIEW),
	PERSON_EXPORT(UserRightGroup.PERSON, UserRight._PERSON_VIEW),
	PERSON_CONTACT_DETAILS_DELETE(UserRightGroup.PERSON, UserRight._PERSON_VIEW),
	...
	SAMPLE_TRANSFER(UserRightGroup.SAMPLE, UserRight._SAMPLE_VIEW),
	SAMPLE_EDIT_NOT_OWNED(UserRightGroup.SAMPLE, UserRight._SAMPLE_VIEW),
	PERFORM_BULK_OPERATIONS_CASE_SAMPLES(UserRightGroup.SAMPLE, UserRight._SAMPLE_VIEW),
	...
	// TODO DOCUMENT_DELETE, TASK_DELETE, SAMPLE_DELETE, VISIT_DELETE, PERSON_DELETE and ACTION_DELETE
	CONTACT_DELETE(UserRightGroup.CONTACT, UserRight._CONTACT_VIEW, UserRight._SAMPLE_DELETE, UserRight._TASK_DELETE),
	...
	CONTACT_REASSIGN_CASE(UserRightGroup.CONTACT, UserRight._CONTACT_VIEW),
	CONTACT_MERGE(UserRightGroup.CONTACT, UserRight._CONTACT_VIEW),
	CONTACT_RESPONSIBLE(UserRightGroup.CONTACT, UserRight._CONTACT_VIEW),

	// TODO - case/contact
	VISIT_CREATE(UserRightGroup.VISIT, UserRight._CASE_VIEW, UserRight._CONTACT_VIEW),
	VISIT_EDIT(UserRightGroup.VISIT, UserRight._CASE_EDIT, UserRight._CONTACT_EDIT),
	VISIT_DELETE(UserRightGroup.VISIT, UserRight._CASE_VIEW, UserRight._CONTACT_VIEW),
	VISIT_EXPORT(UserRightGroup.VISIT, UserRight._CASE_VIEW, UserRight._CONTACT_VIEW),
	...
	TASK_ASSIGN(UserRightGroup.TASK, UserRight._TASK_VIEW),
	...
	// TODO DOCUMENT_DELETE, TASK_DELETE, EVENT_PARTICIPANT_DELETE
	...
	PERFORM_BULK_OPERATIONS_EVENT(UserRightGroup.EVENT, UserRight._EVENT_VIEW),
	EVENT_RESPONSIBLE(UserRightGroup.EVENT, UserRight._EVENT_VIEW),
	...
	// TODO DOCUMENT_DELETE, SAMPLE_DELETE, PERSON_DELETE
	EVENTPARTICIPANT_DELETE(UserRightGroup.EVENT, UserRight._EVENTPARTICIPANT_VIEW, UserRight._SAMPLE_DELETE),
	EVENTPARTICIPANT_IMPORT(UserRightGroup.EVENT, UserRight._EVENTPARTICIPANT_VIEW),
	PERFORM_BULK_OPERATIONS_EVENTPARTICIPANT(UserRightGroup.EVENT, UserRight._EVENTPARTICIPANT_VIEW),
	...
	EVENTGROUP_LINK(UserRightGroup.EVENT, UserRight._EVENT_VIEW),
	...
	// TODO CAMPAIGN_FORM_DATA_DELETE
	CAMPAIGN_DELETE(UserRightGroup.CAMPAIGN, UserRight._CAMPAIGN_VIEW),
	...
	// TODO DOCUMENT_DELETE, TASK_DELETE
	TRAVEL_ENTRY_DELETE(UserRightGroup.TRAVEL_ENTRY, UserRight._TRAVEL_ENTRY_VIEW),

	PERFORM_BULK_OPERATIONS(UserRightGroup.GENERAL),
	PERFORM_BULK_OPERATIONS_PSEUDONYM(UserRightGroup.GENERAL),
	// TODO case/contact/event/participant
