...
public class SampleMaterialTest {
	...
	public void testActiveMaterialsMatchUpgradedSpec() {
		...
		// Issue #13560 defines exactly 44 active specimen types
		assertThat(active, hasSize(44));
	}
	...
	public void testDeprecatedMaterials() {
		...
		assertThat(
			...
			containsInAnyOrder(
				...
				SampleMaterial.INTESTINAL_FLUID,
				SampleMaterial.DUODENUM_FLUID,
				SampleMaterial.LOWER_RESPIRATORY_TRACT,
	...
	private static Map<SampleMaterial, String> expectedSnomedCodes() {
		...
		map.put(SampleMaterial.THROAT_SWAB, "258529004");
