...
public class InfoProviderTest {
	...
	public void testIsCompatibleToApiString() throws Exception {
		...
		assertEquals(CompatibilityCheckResponse.ERROR, InfoProvider.get().isCompatibleToApi("1.0"));
		assertEquals(CompatibilityCheckResponse.ERROR, InfoProvider.get().isCompatibleToApi("wrong.format.test"));
	}
}
