...
public class EventParticipantEditImmunizationListFragment extends BaseEditFragment<FragmentFormListLayoutBinding, List<Immunization>, EventParticipant>
	implements OnListItemClickListener {

	private ImmunizationListAdapter adapter;

	public static EventParticipantEditImmunizationListFragment newInstance(EventParticipant activityRootData) {
		return newInstance(EventParticipantEditImmunizationListFragment.class, null, activityRootData);
	}
