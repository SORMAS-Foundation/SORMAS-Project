...
public enum VisualState {
    ...
    NORMAL(R.drawable.selector_text_control_edit, R.drawable.selector_text_control_edit,
            R.drawable.selector_spinner, R.drawable.selector_spinner_filter, R.drawable.selector_text_filter,
            R.drawable.control_switch_background_border, R.color.controlLabelColor, R.color.controlTextColor, R.color.controlTextViewHint),
    FOCUSED(R.drawable.selector_text_control_edit, R.drawable.selector_text_control_edit,
            R.drawable.selector_spinner, R.drawable.selector_spinner_filter, R.drawable.selector_text_filter, R.drawable.selector_text_control_edit,
    ...
    ERROR(R.drawable.selector_text_control_edit_error, R.drawable.selector_text_control_edit_error,
            R.drawable.selector_spinner_error, R.drawable.selector_spinner_filter, R.drawable.selector_text_filter, R.drawable.control_switch_background_border_error,
    ...
    VisualState(int backgroundTextField, int backgroundCheckbox, int backgroundSpinner,
                int backgroundSpinnerFilter, int backgroundTextFilter, int backgroundSwitch,
                int labelColor, int textColor, int hintColor) {
