...
public interface SampleFacadeRetro {
	...
	@GET("samples/all/{since}/{size}/{lastSynchronizedUuid}")
	Call<List<SampleDto>> pullAllSince(@Path("since") long since, @Path("size") int size, @Path("lastSynchronizedUuid") String lastSynchronizedUuid);
