...
import de.symeda.sormas.app.databinding.RowEditTaskListItemLayoutBinding;
...
public class ContactEditTaskListAdapter extends DataBoundAdapter<RowEditTaskListItemLayoutBinding> {

    private static final String TAG = ContactEditTaskListAdapter.class.getSimpleName();
    ...
    public ContactEditTaskListAdapter(Context context, int rowLayout, OnListItemClickListener onListItemClickListener) {
        this(context, rowLayout, onListItemClickListener, new ArrayList<Task>());
    }

    public ContactEditTaskListAdapter(Context context, int rowLayout, OnListItemClickListener onListItemClickListener, List<Task> data) {
        super(rowLayout);
    ...
    @Override
    protected void bindItem(DataBoundViewHolder<RowEditTaskListItemLayoutBinding> holder,
