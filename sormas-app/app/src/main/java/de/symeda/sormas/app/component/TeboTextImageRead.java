...
public class TeboTextImageRead extends TeboTextRead {
    ...
    protected void inflateView(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.control_textfield_read_text_image_layout, this);
    }
    ...
    protected void onFinishInflate() {
        ...
        imgTextImage = (ImageView) this.findViewById(R.id.imgTextImage);

        imgTextImage.setNextFocusLeftId(getNextFocusLeft());
        imgTextImage.setNextFocusRightId(getNextFocusRight());
        imgTextImage.setNextFocusUpId(getNextFocusUp());
        imgTextImage.setNextFocusDownId(getNextFocusDown());
        imgTextImage.setNextFocusForwardId(getNextFocusForward());
