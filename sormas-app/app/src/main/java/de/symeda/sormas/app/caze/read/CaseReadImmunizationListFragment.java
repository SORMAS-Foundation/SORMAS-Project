...
public class CaseReadImmunizationListFragment extends BaseReadFragment<FragmentFormListLayoutBinding, List<Immunization>, Case>
	implements OnListItemClickListener {

	private ImmunizationListAdapter immunizationListAdapter;

	public static CaseReadImmunizationListFragment newInstance(Case activityRootData) {
		return newInstance(CaseReadImmunizationListFragment.class, null, activityRootData);
	}
