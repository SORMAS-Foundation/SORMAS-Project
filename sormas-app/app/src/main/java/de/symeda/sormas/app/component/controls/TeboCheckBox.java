...
public class TeboCheckBox extends ControlPropertyEditField<Boolean> {
    ...
    protected void onFinishInflate() {
        ...
        checkBox.setTextAlignment(getControlTextAlignment());
        if(getControlTextAlignment() == View.TEXT_ALIGNMENT_GRAVITY) {
            checkBox.setGravity(getControlGravity());
        }
