...
public class CaseEditPrescriptionListFragment extends BaseEditFragment<FragmentFormListLayoutBinding, List<Prescription>, Case> implements OnListItemClickListener {
