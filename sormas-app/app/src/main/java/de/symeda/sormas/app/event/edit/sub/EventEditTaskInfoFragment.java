...
public class EventEditTaskInfoFragment extends BaseEditActivityFragment<FragmentTaskEditLayoutBinding, Task, Task> {
    ...
    public static EventEditTaskInfoFragment newInstance(IActivityCommunicator activityCommunicator, TaskFormNavigationCapsule capsule, Task activityRootData)
            throws java.lang.InstantiationException, IllegalAccessException {
        return newInstance(activityCommunicator, EventEditTaskInfoFragment.class, capsule, activityRootData);
    }
