...
public class CaseReadTaskListAdapter extends DataBoundAdapter<RowReadCaseTaskListItemLayoutBinding> {
    ...
    @Override
    protected void bindItem(DataBoundViewHolder<RowReadCaseTaskListItemLayoutBinding> holder,
    ...
    public void updateUnreadIndicator(DataBoundViewHolder<RowReadCaseTaskListItemLayoutBinding> holder, Task item) {
