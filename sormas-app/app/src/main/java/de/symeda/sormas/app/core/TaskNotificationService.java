    ...
    public static void doTaskNotification(Context context) {
        ...
        for (Task task : taskList) {
            ...
            Notification notification = new NotificationCompat.Builder(context)
                    ...
                    .setContentTitle(task.getTaskType().toString() + (caze != null && caze.getDisease() != null ? " (" + caze.getDisease().toShortString() + ")" : contact != null ? " (" + contact.getCaze().getDisease().toShortString() + ")" : ""))
