...
public class CasePickOrCreateDialog extends AbstractDialog {
    ...
    private CasePickOrCreateDialog(final FragmentActivity activity, Case newCase) {
        super(activity, R.layout.dialog_root_layout, R.layout.dialog_case_pick_or_create_layout,
                R.layout.dialog_root_two_button_panel_layout,
                R.string.heading_pick_or_create_case, -1);

        CaseCriteria caseCriteria = new CaseCriteria()
                .setRegion(newCase.getRegion())
                .setDisease(newCase.getDisease());
        this.criteria = new CaseSimilarityCriteria()
                .setCaseCriteria(caseCriteria)
        ...
        similarCaseItemClickCallback = (v, item) -> {
            ...
            for (View itemView : views) {
                try {
                    ...
                    NotificationHelper.showDialogNotification(CasePickOrCreateDialog.this,
