...
public class EventSummaryFragment extends BaseSummaryFragment<ViewTypeHelper.ViewTypeEnum, EventSummaryAdapter> {
    ...
    private List<SummaryCircularData> getCircularDataAsync() {
        ...
        //Fatalities
        SummaryCircularData data4 = new SummaryCircularData(titleRumor, random.nextInt(10000), random.nextInt(100), R.color.circularProgressFinishedWarning,
                R.color.circularProgressUnfinishedWarning);

        //Case Fatality Rate
        SummaryCircularData data5 = new SummaryCircularData(titleOutbreak, random.nextInt(10000), random.nextInt(100), R.color.circularProgressFinishedWatchOut,
