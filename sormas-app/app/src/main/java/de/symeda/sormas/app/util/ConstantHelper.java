...
public class ConstantHelper {
    ...
    public static final String ARG_SEARCH_STRATEGY = "searchStrategy";

    public static final String ARG_LIST_FILTER_STATUS = "listFilterStatus";
    public static final String ARG_FILTER_STATUS = "filterStatus";
    public static final String ARG_PAGE_STATUS = "pageStatus";
    public static final String ARG_PAGE_RECORD = "pageRecord";
    public static final String NEW_SAMPLE = "newSample";

    public static final String KEY_DATA_UUID = "uuid";
    public static final String KEY_PERSON_UUID = "personUuid";
    ...
    public static final String ARG_DISEASE = "diseaseArg";
    ...
    public static final int INDEX_SECOND_MENU = 1;
    public static final int INDEX_THIRD_MENU = 2;
    public static final int INDEX_FORTH_MENU = 3;
    public static final int INDEX_FIFTH_MENU = 4;
    public static final int INDEX_SIXTH_MENU = 5;
