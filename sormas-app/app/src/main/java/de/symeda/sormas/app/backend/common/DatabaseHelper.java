...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	public static final int DATABASE_VERSION = 292;
...
//					.executeRaw("ALTER TABLE eventParticipants ADD COLUMN vaccinationInfo_id references vaccinationInfo(id)");
			...
			case 291:
				currentVersion = 291;
				getDao(Country.class).executeRaw("ALTER TABLE location ADD COLUMN continent_id BIGINT REFERENCES continent(id);");
				getDao(Country.class).executeRaw("ALTER TABLE location ADD COLUMN subcontinent_id BIGINT REFERENCES subcontinent(id);");
