...
public class ContactEditTaskInfoFragment extends BaseEditActivityFragment<FragmentTaskEditLayoutBinding> implements OnTeboSwitchCheckedChangeListener {
    ...
    public static ContactEditTaskInfoFragment newInstance(TaskFormNavigationCapsule capsule)
            throws java.lang.InstantiationException, IllegalAccessException {
        return newInstance(ContactEditTaskInfoFragment.class, capsule);
    }
}
