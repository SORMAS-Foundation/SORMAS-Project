...
public class ContactEditTaskInfoFragment extends BaseEditActivityFragment<FragmentTaskEditLayoutBinding, Task> {
    ...
    public static ContactEditTaskInfoFragment newInstance(IActivityCommunicator activityCommunicator, TaskFormNavigationCapsule capsule)
            throws java.lang.InstantiationException, IllegalAccessException {
        return newInstance(activityCommunicator, ContactEditTaskInfoFragment.class, capsule);
    }
}
