...
public class ContactReadImmunizationListFragment extends BaseReadFragment<FragmentFormListLayoutBinding, List<Immunization>, Contact>
	implements OnListItemClickListener {

	private ImmunizationListAdapter immunizationListAdapter;

	public static ContactReadImmunizationListFragment newInstance(Contact activityRootData) {
		return newInstance(ContactReadImmunizationListFragment.class, null, activityRootData);
	}
