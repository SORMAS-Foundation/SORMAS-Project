...
import de.symeda.sormas.app.databinding.RowReadCaseSampleListItemLayoutBinding;
...
public class CaseReadSampleListAdapter extends DataBoundAdapter<RowReadCaseSampleListItemLayoutBinding> {
    ...
    @Override
    protected void bindItem(DataBoundViewHolder<RowReadCaseSampleListItemLayoutBinding> holder,
...
//    public void updateUnreadIndicator(DataBoundViewHolder<RowReadCaseSampleListItemLayoutBinding> holder, Sample item) {
