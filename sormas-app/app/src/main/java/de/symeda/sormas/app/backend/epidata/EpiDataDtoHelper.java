...
public class EpiDataDtoHelper extends AdoDtoHelper<EpiData, EpiDataDto> {
    ...
    public void fillInnerFromDto(EpiData a, EpiDataDto b) {
        ...
        a.setRodents(b.getRodents()!=null?YesNoUnknown.valueOf(b.getRodents().name()):null);
        a.setBats(b.getBats()!=null?YesNoUnknown.valueOf(b.getBats().name()):null);
        a.setPrimates(b.getPrimates()!=null?YesNoUnknown.valueOf(b.getPrimates().name()):null);
        a.setSwine(b.getSwine()!=null?YesNoUnknown.valueOf(b.getSwine().name()):null);
        a.setBirds(b.getBirds()!=null?YesNoUnknown.valueOf(b.getBirds().name()):null);
        a.setPoultryEat(b.getPoultryEat()!=null?YesNoUnknown.valueOf(b.getPoultryEat().name()):null);
        ...
        a.setCattle(b.getCattle()!=null?YesNoUnknown.valueOf(b.getCattle().name()):null);
        a.setOtherAnimals(b.getOtherAnimals()!=null?YesNoUnknown.valueOf(b.getOtherAnimals().name()):null);
        a.setOtherAnimalsDetails(b.getOtherAnimalsDetails());
        a.setWildbirds(b.getWildbirds()!=null?YesNoUnknown.valueOf(b.getWildbirds().name()):null);
