...
import de.symeda.sormas.app.component.OnTeboRadioButtonCheckedChangeListener;
...
public class TeboRadioGroup extends ControlPropertyEditField<Object> {
    ...
    protected void onFinishInflate() {
        ...
        captionFrame = this.findViewById(R.id.label_frame);
    ...
    public void changeVisualState(VisualState state) {
        ...
        Drawable drawable = getResources().getDrawable(state.getBackground(VisualStateControlType.CHECKBOX));
