...
public class DiseaseClassificationDtoHelper extends AdoDtoHelper<DiseaseClassificationCriteria, DiseaseClassificationCriteriaDto> {
    ...
    @Override
    protected DiseaseClassificationCriteria handlePulledDto(AbstractAdoDao<DiseaseClassificationCriteria> dao, DiseaseClassificationCriteriaDto dto) throws DaoException, SQLException {
