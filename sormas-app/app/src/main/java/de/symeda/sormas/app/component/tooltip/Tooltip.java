...
public final class Tooltip {
    ...
    static class TooltipViewImpl extends ViewGroup implements TooltipView {
        ...
        private void initializeView() {
            ...
            Utils.log(TAG, VERBOSE, "[%d] initializeView", mToolTipId);
        ...
        private void calculatePositions(List<Gravity> gravities, final boolean checkEdges) {
            ...
            if (dbg) {
                Utils.log(TAG, VERBOSE, "[%d] mScreenRect: %s, mTopRule: %d, statusBar: %d", mToolTipId, mScreenRect, mTopRule,
                    statusbarHeight
                );
        ...
        private void onClose(boolean fromUser, boolean containsTouch, boolean immediate) {
            Utils.log(TAG, INFO, "[%d] onClose. fromUser: %b, containsTouch: %b, immediate: %b",
                mToolTipId,
                fromUser,
                containsTouch,
                immediate
