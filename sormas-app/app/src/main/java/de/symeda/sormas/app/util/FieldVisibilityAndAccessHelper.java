...
public class FieldVisibilityAndAccessHelper {
    public static void setFieldVisibilitiesAndAccesses(Class<?> dtoClass, ViewGroup viewGroup,
                                                       FieldVisibilityCheckers visibilityCheckers, FieldAccessCheckers accessCheckers) {
