...
public class ImmunizationReadVaccinationListFragment extends BaseReadFragment<FragmentFormListLayoutBinding, List<VaccinationEntity>, Immunization>
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        model.getVaccinations().observe(this, vaccinationEntities -> {
            adapter.submitList(vaccinationEntities);
            ((ImmunizationReadActivity) getActivity()).hidePreloader();
            updateEmptyListHint(vaccinationEntities);
        });
    }
    ...
    public void onListItemClick(View view, int position, Object item) {
        ...
        VaccinationReadActivity.startActivity(getActivity(), vaccinationEntity.getUuid());
    }
}
