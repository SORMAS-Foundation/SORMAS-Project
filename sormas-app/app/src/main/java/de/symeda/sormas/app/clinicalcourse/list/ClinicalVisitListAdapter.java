...
import de.symeda.sormas.app.databinding.RowClinicalVisitListItemLayoutBinding;

public class ClinicalVisitListAdapter extends BindingPagedListAdapter<ClinicalVisit, RowClinicalVisitListItemLayoutBinding> {

	public ClinicalVisitListAdapter() {
		super(R.layout.row_clinical_visit_list_item_layout);
	}
