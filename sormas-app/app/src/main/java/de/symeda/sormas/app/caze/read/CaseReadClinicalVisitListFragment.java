...
import de.symeda.sormas.app.therapy.read.TreatmentReadActivity;

public class CaseReadClinicalVisitListFragment extends BaseReadFragment<FragmentFormListLayoutBinding, List<ClinicalVisit>, Case> implements OnListItemClickListener {
...
//        ClinicalVisitReadActivity.startActivity(getActivity(), clinicalVisit.getUuid());
    }
