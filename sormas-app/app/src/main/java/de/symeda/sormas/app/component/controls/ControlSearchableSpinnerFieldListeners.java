...
public class ControlSearchableSpinnerFieldListeners implements AdapterView.OnItemSelectedListener {
    ...
    public void registerListener(final ValueChangeListener listener, final ControlSearchableSpinnerField field) {
