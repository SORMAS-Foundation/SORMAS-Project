...
public class ContactEditImmunizationListFragment extends BaseEditFragment<FragmentFormListLayoutBinding, List<Immunization>, Contact>
	implements OnListItemClickListener {

	private ImmunizationListAdapter adapter;

	public static ContactEditImmunizationListFragment newInstance(Contact activityRootData) {
		return newInstance(ContactEditImmunizationListFragment.class, null, activityRootData);
	}
	...
	protected String getSubHeadingTitle() {
		...
		return r.getString(R.string.caption_contact_immunizations);
	}
