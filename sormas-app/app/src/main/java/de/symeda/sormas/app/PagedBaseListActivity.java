...
public abstract class PagedBaseListActivity<T extends AbstractDomainObject> extends BaseActivity implements IUpdateSubHeadingTitle, PageMenuControl.NotificationCountChangingListener {
    ...
    protected BasePagedDataBoundAdapter<T, ?> adapter;
    ...
    public BasePagedDataBoundAdapter<?, ?> getAdapter() {
        return adapter;
    }
}
