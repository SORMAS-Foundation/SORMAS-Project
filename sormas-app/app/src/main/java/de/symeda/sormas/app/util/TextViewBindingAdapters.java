...
public class TextViewBindingAdapters {
	...
	@BindingAdapter(value = {
		...
		"valueCaption",
		"defaultValue" })
	public static void setFacilityValueWithCaption(
		TextView view,
		Facility facility,
		String facilityDetailsValue,
		String valueCaption,
		String defaultValue) {
		if (facility != null) {
			setValueWithCaption(
				view,
				FacilityHelper.buildFacilityString(facility.getUuid(), facility.getName(), facilityDetailsValue),
				valueCaption,
				defaultValue);
		} else {
	...
	@BindingAdapter(value = {
		...
		"valueFormat",
		"defaultValue" }, requireAll = true)
	public static void setValueWithPrepend(
		TextView textField,
	...
	@BindingAdapter(value = {
		...
		"valueFormat",
		"defaultValue" }, requireAll = true)
	public static void setLocationValueWithPrepend(
		TextView textField,
		Location location,
		String prependValue,
		String valueFormat,
	...
	@BindingAdapter(value = {
		...
		"valueFormat",
		"defaultValue" }, requireAll = true)
	public static void setAgeWithDateValueAndPrepend(
		TextView textField,
		Person person,
		String prependValue,
		String valueFormat,
	...
	public static void setYesNoUnknown(TextView textField, YesNoUnknown yesNoUnknown) {
		if (yesNoUnknown == null) {
			...
			String caption =
				I18nProperties.getCaption(ControlPropertyField.getPropertyIdPrefix(fieldId), ControlPropertyField.getSubPropertyId(fieldId));
