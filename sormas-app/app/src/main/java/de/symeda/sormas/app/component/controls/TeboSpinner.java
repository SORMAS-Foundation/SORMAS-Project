...
import de.symeda.sormas.app.component.ISpinnerFieldInterface;
import de.symeda.sormas.app.component.Item;
import de.symeda.sormas.app.component.OnTeboSpinnerAttachedToWindowListener;
import de.symeda.sormas.app.component.SpinnerFieldListener;
...
public class TeboSpinner extends ControlPropertyEditField<Object> implements ISpinnerFieldInterface {
    ...
    protected void onFinishInflate() {
        ...
        spnControlInput = (Spinner) this.findViewById(R.id.input);
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (parentValue == null){
                        ...
                        nSelf.spinnerFieldListener.onItemSelected(nSelf.spnControlInput,
                                nSelf.spnControlInput.findViewById(R.id.text),
