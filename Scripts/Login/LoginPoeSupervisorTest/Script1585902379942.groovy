...
WebUI.callTestCase(findTestCase('Login/partials/LoginAsPoeSupervisor'), [:], FailureHandling.STOP_ON_FAILURE)
...
try {
    ...
    WebUI.verifyElementPresent(findTestObject('Login/MainView/menu_Configuration'), 2)
