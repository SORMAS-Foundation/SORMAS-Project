...
public class Contact {
  ...
  String quarantine;
  String highPriority;
  String preexistingConditionDiabetes;
  String preexistingConditionHiv;
  String preexistingConditionLiver;
  String preexistingConditionMalignancy;
  String preexistingConditionChronicPulmonary;
  String preexistingConditionRenal;
  String preexistingConditionNeurologic;
  String preexistingConditionCardiovascular;
