...
public class EditEventPage {
  ...
  public static final By STUDY_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Studie']");
  public static final By CASE_CONTROL_STUDY_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Fall-Kontroll-Studie']");
  public static final By COHORT_STUDY_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Kohorten-Studie']");
  public static final By EXPLORATIVE_SURVEY_OF_AFFECTED_PEOPLE_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Explorative Befragung der Betroffenen']");
  public static final By CONTACT_TO_SICK_PERSON_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Kontakt zu Erkrankten']");
  public static final By CONTACT_TO_CONTAMINATED_MATERIALS_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Kontakt zu kontaminierten Gegenst\u00E4nden']");
  public static final By DESCRIPTIVE_ANALYSIS_OF_ASCETAINED_DATA_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Deskriptive Auswertung der ermittelten Daten']");
  public static final By TEMPORAL_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath(
          "//label[text()='Zeitlich: zeitliches Auftreten der Erkrankung deutet auf gemeinsame Infektionsquelle hin']");
  public static final By SPATIAL_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath(
          "//label[text()='R\u00E4umlich: Mehrzahl der F\u00E4lle war im angenommenen Infektionszeitraum am selben Ort']");
  public static final By PERSON_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath(
          "//label[text()='Person: F\u00E4lle haben direkten oder indirekten Kontakt miteinander gehabt']");
  public static final By SUSPICION_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Vermutung']");
  public static final By EXPRESSED_BY_THE_DISEASE_PERSON_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Von den erkrankten Personen ge\u00E4u\u00DFert']");
  public static final By EXPRESSED_BY_THE_HEALTH_DEPARTMENT_EPIDEMIOLOGICAL_EVIDENCE_BUTTON =
  ...
  public static final By COMPLIANT_PATHOGEN_FINE_TYPING_LABORATORY_DIAGNOSTIC_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Erreger-Feintypisierung stimmt \u00FCberein']");
  public static final By VERIFICATION_ON_MATERIALS_LABORATORY_DIAGNOSTIC_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Nachweis an Gegenst\u00E4nden']");
  public static final By IMPRESSION_TEST_LABORATORY_DIAGNOSTIC_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Abklatschprobe (z.B. Kan\u00FClen, Katheter)']");
  public static final By WATER_SAMPLE_LABORATORY_DIAGNOSTIC_EVIDENCE_BUTTON =
      By.xpath("//label[text()='Wasserprobe']");
  public static final By OTHER_LABORATORY_DIAGNOSTIC_EVIDENCE_BUTTON =
