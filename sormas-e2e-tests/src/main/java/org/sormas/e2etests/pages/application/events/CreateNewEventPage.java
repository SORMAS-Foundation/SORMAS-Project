...
public class CreateNewEventPage {
    ...
    public static final By EVENT_STATUS_OPTIONS = By.cssSelector("#eventStatus .v-select-option label");
    public static final By RISK_LEVEL_COMBOBOX = By.cssSelector(".popupContent #riskLevel div");
    public static final By EVENT_MANAGEMENT_STATUS_OPTIONS = By.cssSelector(".popupContent #eventManagementStatus .v-select-option label");
    public static final By MULTI_DAY_EVENT_CHECKBOX = By.cssSelector(".popupContent #multiDayEvent input");
    public static final By START_DATA_INPUT = By.cssSelector(".popupContent #startDate input");
    public static final By SIGNAL_EVOLUTION_DATE_INPUT = By.cssSelector(".popupContent #evolutionDate input");
    public static final By EVENT_INVESTIGATION_STATUS_OPTIONS = By.cssSelector(".popupContent #eventInvestigationStatus label");
    ...
    public static final By ADDITIONAL_INFORMATION_INPUT = By.cssSelector(".popupContent #additionalInformation");
    ...
    public static final By COMMUNITY_CONTACT_PERSON_COMBOBOX = By.cssSelector(".popupContent #details");
    ...
    public static final By PRIMARY_MODE_OF_TRANSMISSION = By.cssSelector(".popupContent #diseaseTransmissionMode");
    public static final By NOSOCOMIAL = By.cssSelector(".popupContent #nosocomial");
    public static final By EVENT_INVESTIGATION_START_DATE = By.cssSelector(".popupContent #eventInvestigationStartDate");
    public static final By EVENT_INVESTIGATION_END_DATE = By.cssSelector(".popupContent #eventInvestigationEndDate");
    ...
    public static final By SOURCE_INSTITUTIONAL_PARTNER = By.cssSelector(".popupContent #srcInstitutionalPartnerType div");
    public static final By SOURCE_INSTITUTIONAL_PARTNER_DETAILS = By.cssSelector(".popupContent #srcInstitutionalPartnerTypeDetails");
    public static final By SPECIFY_OTHER_EVENT_PLACE = By.cssSelector(".popupContent #typeOfPlaceText");
    ...
    public static final By MEANS_OF_TRANSPORT_DETAILS = By.cssSelector(".popupContent #meansOfTransportDetails");
