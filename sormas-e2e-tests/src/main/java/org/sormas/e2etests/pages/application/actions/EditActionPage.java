...
public class EditActionPage {
  ...
  public static final By DOWNLOAD_LAST_UPDATED_DOCUMENT =
      By.xpath(
          "(//div[@class='v-button v-widget caption-overflow-label v-button-caption-overflow-label'])[1]");
  public static final By DELETE_LAST_UPDATED_DOCUMENT =
      By.xpath(
          "(//div[@class='v-button v-widget caption-overflow-label v-button-caption-overflow-label'])[2]");
