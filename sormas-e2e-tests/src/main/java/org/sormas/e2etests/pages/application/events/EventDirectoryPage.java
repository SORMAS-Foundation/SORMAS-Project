...
public class EventDirectoryPage {
  ...
  public static final By EVENT_ACTIONS_RADIOBUTTON = By.cssSelector("div#eventsViewSwitcher span:nth-child(2)");
  public static final By FILTER_BY_GENERAL_INPUT = By.id("input#freeText");
  public static final By EVENT_ACTIONS_COLUMN_HEADERS =
          By.cssSelector("thead .v-grid-column-default-header-content");
  public static final By EVENT_ACTIONS_TABLE_ROW = By.cssSelector("div.v-grid-tablewrapper tbody tr");
  public static final By EVENT_ACTIONS_TABLE_DATA = By.tagName("td");
  public static final By ACTION_DIRECTORY_HEADER_TEXT = By.xpath("//div[contains(text(),'Action Directory')]");
