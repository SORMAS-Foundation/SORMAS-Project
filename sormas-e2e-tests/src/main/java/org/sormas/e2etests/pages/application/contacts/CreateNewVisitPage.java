...
public class CreateNewVisitPage {
    ...
    public static final By SOURCE_BODY_TEMPERATURE_COMBOBOX = By.cssSelector("#temperatureSource div");
    ...
    public static final By OXIGEN_SATURANTION_LABEL = By.cssSelector("#oxygenSaturationLower94 > span label");
    public static final By PNEUMONIA_LABEL = By.cssSelector("#pneumoniaClinicalOrRadiologic > span label");
    public static final By RAPID_BREATHING_LABEL = By.cssSelector("#rapidBreathing > span label");
    public static final By RESPIRATORY_DISEASE_REQUIRING_VENTILATION_LABEL = By.cssSelector("#respiratoryDiseaseVentilation > span label");
    public static final By RUNNY_NOSE_LABEL = By.cssSelector("#runnyNose > span label");
    public static final By ACUTE_RESPIRATORY_DISTRESS_SYNDROME_LABEL = By.cssSelector("#acuteRespiratoryDistressSyndrome > span label");
    ...
    public static final By OTHER_CLINICAL_SYMPTOMS_LABEL = By.cssSelector("#otherNonHemorrhagicSymptoms > span label");
