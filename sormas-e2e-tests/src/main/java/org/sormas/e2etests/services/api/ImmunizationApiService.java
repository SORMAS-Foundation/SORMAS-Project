...
import org.sormas.e2etests.enums.Districts;
import org.sormas.e2etests.enums.Regions;
...
public class ImmunizationApiService {
  ...
  public Immunization buildGeneratedImmunizationForPerson(Person person) {
    ...
    return Immunization.builder()
        ...
        .responsibleRegion(Regions.VoreingestellteBundeslander.toString())
        .responsibleDistrict(Districts.VoreingestellterLandkreis.toString())
