...
public class ContactService {
  ...
  public Exposure buildGeneratedExposureDataForContact() {
    return Exposure.builder()
        ...
        .typeOfPlaceDetails("Some type of place details")
        ...
        .facilityDetails("Some facility details")
        ...
        .contactPersonEmail(faker.name().firstName() + faker.name().lastName() + emailDomain)
        .build();
  }
}
