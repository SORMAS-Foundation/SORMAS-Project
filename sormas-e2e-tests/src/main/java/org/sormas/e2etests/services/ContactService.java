...
public class ContactService {
  ...
  public Contact buildEditContact() {
    return Contact.builder()
        ...
        .dateOfLastContact(LocalDate.now().minusDays(2))
        ...
        .preexistingConditionDiabetes("YES")
        .preexistingConditionHiv("NO")
        .preexistingConditionLiver("NO")
        .preexistingConditionMalignancy("NO")
        .preexistingConditionChronicPulmonary("NO")
        .preexistingConditionRenal("YES")
        .preexistingConditionNeurologic("NO")
        .preexistingConditionCardiovascular("NO")
