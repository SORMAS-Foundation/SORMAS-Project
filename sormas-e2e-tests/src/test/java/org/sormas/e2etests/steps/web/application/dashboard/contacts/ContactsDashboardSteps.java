...
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.ALL_CONTACTS_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.APPLY_FILTERS_BUTTON_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CANCELLED_FOLLOW_UP_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CHART_CONTEXT_MENU;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COLLAPSE_FOLLOWUP_STATUS_CHART_BUTTON;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COLLAPSE_MAP_BUTTON;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COMPARISON_PERIOD_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COMPARISON_PERIOD_DASHBOARD_DAY_BEFORE_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COMPARISON_PERIOD_DASHBOARD_SAME_DAY_LAST_YEAR_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COMPLETED_FOLLOW_UP_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONFIRMED_CONTACT_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_CHOLERA_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_CONGENITAL_RUBELLA_COUNTER;
...
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_COVID19_COUNTER_WITHOUT_DETAILS;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_EBOLA_VIRUS_DISEASE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_HUMAN_RABIES_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_INFLUENZA_NEW_SUBTYPE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_IN_QUARANTINE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_LASSA_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_MONKEYPOX_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_NEW_CASES_NOT_PREVIOUSLY_KNOWN_TO_BE_CONTACTS_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_NOT_YET_DEFINED_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_OTHER_EPIDEMIC_DISEASE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_PER_CASE_AVERAGE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_PER_CASE_MAX_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_PER_CASE_MIN_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_PLACED_IN_QUARANTINE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_PLAGUE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_RADIO_BUTTON;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONTACTS_UNSPECIFIED_WHF_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CONVERTED_TO_CASE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COOPERATIVE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.COOPERATIVE_VISITS_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_DASHBOARD_CUSTOM_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_DASHBOARD_LAST_WEEK_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_DASHBOARD_THIS_WEEK_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_DASHBOARD_THIS_YEAR_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_DASHBOARD_TODAY_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.CURRENT_PERIOD_DASHBOARD_YESTERDAY_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DASHBOARD_DATA_DROPDOWN;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DASHBOARD_GROUPING_DROPDOWN;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DASHBOARD_MAP_KEYS;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DASHBOARD_MAP_LAYERS;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DISEASE_FILTER_COMBOBOX_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DOWNLOAD_CSV_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DOWNLOAD_JPEG_IMAGE_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DOWNLOAD_PDF_DOCUMENT_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DOWNLOAD_PNG_IMAGE_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DOWNLOAD_SVG_VECTOR_IMAGE_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.DOWNLOAD_XLS_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.ENLARGE_FOLLOWUP_STATUS_CHART_BUTTON;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.EXPAND_MAP_BUTTON;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.FOLLOWUP_STATUS_CHART_CANCELED_FU;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.FOLLOWUP_STATUS_CHART_COMPLETED_FU;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.FOLLOWUP_STATUS_CHART_LOST_TO_FU;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.FOLLOWUP_STATUS_CHART_UNDER_FU;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.LOST_TO_FOLLOW_UP_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.MISSED_VISITS_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.NEVER_VISITED_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.NEW_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.NOT_A_CONTACT_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.PRINT_CHART_OPTION;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.REGION_FILTER_COMBOBOX_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.RESET_FILTERS_BUTTON_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.SHOW_ALL_DISEASES_BUTTON_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.SHOW_FIRST_DISEASES_BUTTON_CONTACTS_DASHBOARD;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.STOPPED_FOLLOWUP_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.SYMPTOMATIC_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.UNAVAILABLE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.UNAVAILABLE_VISITS_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.UNCONFIRMED_CONTACT_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.UNCOOPERATIVE_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.UNCOOPERATIVE_VISITS_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.UNDER_FOLLOWUP_COUNTER;
import static org.sormas.e2etests.pages.application.dashboard.Surveillance.ContactsDashboardPage.VISITS_COUNTER;
    ...
    When(
        ...
        () -> {
          ...
          webDriverHelpers.waitUntilIdentifiedElementIsVisibleAndClickable(
              CONTACTS_COVID19_COUNTER_WITHOUT_DETAILS, 40);
          covid19ContactsCounterBefore =
              Integer.parseInt(
                  webDriverHelpers.getTextFromWebElement(CONTACTS_COVID19_COUNTER_WITHOUT_DETAILS));
        });
    ...
    Then(
        ...
        () -> {
          ...
          webDriverHelpers.waitUntilIdentifiedElementIsPresent(
              CONTACTS_COVID19_COUNTER_WITHOUT_DETAILS);
