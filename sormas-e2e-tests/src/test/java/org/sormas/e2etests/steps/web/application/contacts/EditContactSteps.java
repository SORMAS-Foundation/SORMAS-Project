...
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.ADDITIONAL_RELEVANT_PRE_CONDITIONS_TEXT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.CANCEL_FOLLOW_UP_BUTTON;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.CARDIOVASCULAR_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.CARE_OVER_60_OPTIONS;
...
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.CONTACT_CLASSIFICATION_RADIO_BUTTON;
...
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.CREATE_CASE_FROM_CONTACT_BUTTON;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.DELETE_BUTTON;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.DELETE_POPUP_YES_BUTTON;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.DESCRIPTION_OF_HOW_CONTACT_TOOK_PLACE_INPUT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.DIABETES_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.DISEASE_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.EXTERNAL_ID_INPUT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.EXTERNAL_TOKEN_INPUT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.EXTRA_COMMENT_INPUT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.FIRST_DAY_CONTACT_DATE;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.FOLLOW_UP_STATUS_TEXT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.FOLLOW_UP_UNTIL_DATE;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.GENERAL_COMMENT_TEXT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.HIGH_PRIORITY_CHECKBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.HIGH_PRIORITY_LABEL;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.HIV_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.HOME_BASED_QUARANTINE_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.IDENTIFICATION_SOURCE_INPUT;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.IMMUNOSUPPRESSIVE_THERAPY_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.LAST_CONTACT_DATE;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.LIVER_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.MALIGNANCY_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.MULTI_DAY_CONTACT_CHECKBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.MULTI_DAY_CONTACT_LABEL;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.NEUROLOGIC_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.OVERWRITE_FOLLOW_UP_LABEL;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.PROHIBITION_TO_WORK_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.PULMONARY_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.QUARANTINE_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.QUARANTINE_ORDER_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.RELATIONSHIP_WITH_CASE_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.RENAL_OPTIONS;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.REPORTING_DISTRICT_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.REPORT_DATE;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.RESPONSIBLE_COMMUNITY_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.RESPONSIBLE_DISTRICT_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.RESPONSIBLE_REGION_COMBOBOX;
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.RESPONSIBLE_STATUS_OFFICER_COMBOBOX;
...
import static org.sormas.e2etests.pages.application.contacts.EditContactPage.VACCINATION_STATUS_COMBOBOX;
