...
public class EventParticipantHelper {
  ...
  @Inject
  public EventParticipantHelper(RestAssuredClient restAssuredClient, ObjectMapper objectMapper) {
  ...
  public void createEventParticipant(EventParticipant eventParticipant) {
    ...
    List<EventParticipant> listOfContacts = List.of(eventParticipant);
    objectMapper.writeValue(out, listOfContacts);
    restAssuredClient.sendRequest(
        Request.builder()
            .method(Method.POST)
            .path(EVENT_PARTICIPANTS_PATH + "push")
            .body(out.toString())
            .build());
  }
}
