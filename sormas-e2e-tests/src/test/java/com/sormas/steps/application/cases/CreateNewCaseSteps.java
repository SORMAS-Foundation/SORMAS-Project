...
import static com.sormas.pages.application.cases.CreateNewCasePage.*;
import static com.sormas.pages.application.cases.EditCasePage.CASE_SAVED_MESSAGE;

import com.github.javafaker.Faker;
import com.sormas.helpers.WebDriverHelpers;
import com.sormas.pages.application.cases.EditCasePage;
import com.sormas.pojo.Case;
import com.sormas.services.CaseService;
  ...
  public CreateNewCaseSteps(WebDriverHelpers webDriverHelpers, CaseService caseService) {
    ...
    When(
        ...
        () -> {
          ...
          webDriverHelpers.fillInWebElement(DATE_OF_REPORT_INPUT, "4/19/2021");
          webDriverHelpers.selectFromCombobox(DISEASE_COMBOBOX, "COVID-19");
          webDriverHelpers.selectFromCombobox(
              RESPONSIBLE_REGION_COMBOBOX, "Voreingestellte Bundesländer");
          webDriverHelpers.selectFromCombobox(
              RESPONSIBLE_DISTRICT_COMBOBOX, "Voreingestellter Landkreis");
          webDriverHelpers.clickOnWebElementBySelector(PLACE_OF_STAY_HOME);
          webDriverHelpers.selectFromCombobox(SEX_COMBOBOX, "Male");
          webDriverHelpers.fillInWebElement(
              FIRST_NAME_INPUT, "FirstNameAut_" + timestamp + Faker.instance().name().firstName());
          webDriverHelpers.fillInWebElement(
              LAST_NAME_INPUT, "LastNameAut_" + timestamp + Faker.instance().name().lastName());
    ...
    When(
        ...
        () -> {
          caze = caseService.buildGeneratedAddress();
