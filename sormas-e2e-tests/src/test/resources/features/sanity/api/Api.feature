...
Feature: Check basic POSTs RestApi endpoints
  ...
  @tmsLink=SORDEV-5479mk @env_main @precon
  ...
  @tmsLink=SORDEV-5479mk @env_de @precon
  ...
  @tmsLink=SORDEV-5479mk @env_survnet @precon
  ...
  @tmsLink=SORDEV-5479mk @env_s2s_1 @precon
