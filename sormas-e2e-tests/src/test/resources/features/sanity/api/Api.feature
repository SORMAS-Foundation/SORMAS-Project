...
Feature: Check basic POSTs RestApi endpoints
  ...
  @tmsLink=SORDEV-7456mk @env_main @precon
  ...
  @tmsLink=SORDEV-7456mk @env_de @precon
  ...
  @tmsLink=SORDEV-7456mk @env_survnet @precon
  ...
  @tmsLink=SORDEV-7456mk @env_s2s_1 @precon
