...
Given I log in as a Admin User
  ...
  Scenario: Check for Investigation Start and End columns in the detailed event export
    ...
    And I click on the Events button from navbar
    When I click on the Export Event button
    And I click on the Detailed Event Export button
    Then I check if downloaded data generated by detailed event export option contains investigation start and end date columns
  ...
  Scenario: Hide citizenship and country of birth in Detailed Event Participant file
    ...
    And I check if citizenship and country of birth is not present in Detailed Event Participant export file
