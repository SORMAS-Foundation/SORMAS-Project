...
Feature: Case import and export tests
  ...
  Scenario:  Test Add multiple variables to custom export
    ...
    And I click on the New Export Configuration button in Custom Case Export popup
    Then I fill Configuration Name field with Test Configuration Name
    And I add Investigation status data to export in existing Export Configuration for Custom Case Export
    And I add Date of investigation data to export in existing Export Configuration for Custom Case Export
    And I add Sequelae data to export in existing Export Configuration for Custom Case Export
    And I add Prohibition to work data to export in existing Export Configuration for Custom Case Export
    And I add Quarantine information data to export in existing Export Configuration for Custom Case Export
    And I add Name of responsible clinician data to export in existing Export Configuration for Custom Case Export
    And I add Phone number of responsible clinician data to export in existing Export Configuration for Custom Case Export
    And I add Email address of responsible clinician data to export in existing Export Configuration for Custom Case Export
    And I add Reporting user data to export in existing Export Configuration for Custom Case Export
    And I add Responsible user data to export in existing Export Configuration for Custom Case Export
    Then I save Custom Export Configuration
    When I download created custom case export file
