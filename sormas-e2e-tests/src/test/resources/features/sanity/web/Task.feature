...
Feature: Tasks functionalities
  ...
  Scenario: Test custom task export
    ...
    Then I fill Configuration Name field in Custom Task Export popup
    When I select specific data to export in Export Configuration for Custom Task Export
  ...
  Scenario: Test custom task export edit
    ...
    Then I fill Configuration Name field in Custom Task Export popup
    When I select specific data to export in Export Configuration for Custom Task Export
    And I open edit last created Custom Export Configuration
    And I add specific data to export in existing Export Configuration for Custom Task Export
    When I download last created custom task export file
