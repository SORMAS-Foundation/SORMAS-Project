...
#    And I apply Disease of source filter "COVID-19" on Contact Directory Page
#
#    #Problem z clasification -> TODO wrocic do tego filtra(nie dziala!!!)
...
#  TODO 1)boxy kwarantanny do zoznaczenia i sprawdzenia wartosci boolen 2) CLassification filtr 3)Covid warianty !!!!
...
#    And I check that number of displayed contact results is 1
#
#    And I apply Contact or Case Region filter to "Voreingestellte Bundesländer" on Contact Directory Page
#    And I apply Contact or Case District filter to "Voreingestellter Landkreis" on Contact Directory Page
#    And I apply Contact or Case Community filter to "Voreingestellte Gemeinde" on Contact Directory Page
##    And I apply Responsible Contact filter to {string} on Contact Directory Page
#    And I apply Reported By filter to "National User" on Contact Directory Page
##    And I apply Vaccination status filter to "Geimpft" on Contact Directory Page
#    And I apply Relationship With Case filter to "Anderes Familienmitglied oder Freund" on Contact Directory Page
#
##    Waiting for Api
##    And I apply Year of birth filter to "0000" on Contact Directory Page
##    And I apply Month of birth filter to "1" on Contact Directory Page
##    And I apply Day of birth filter to "23" on Contact Directory Page
