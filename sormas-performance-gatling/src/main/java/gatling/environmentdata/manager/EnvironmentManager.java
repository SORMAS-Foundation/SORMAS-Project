 ...
 */
package gatling.environmentdata.manager;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import gatling.restassured.dtos.*;
import gatling.restassured.RestAssuredClient;
...
import static gatling.restassured.constants.Endpoints.*;


@Slf4j
public class EnvironmentManager {

  private RestAssuredClient restAssuredClient = new RestAssuredClient();
