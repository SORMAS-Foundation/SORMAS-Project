...
public class EmailTemplatesView extends AbstractConfigurationView {
	...
	public EmailTemplatesView() {
		...
		VerticalLayout gridLayout = new VerticalLayout(
			new DocumentTemplateSection(new DocumentTemplateCriteria(CASE_EMAIL, null, null), false, new DocumentTemplateReceiver(CASE_EMAIL)),
			new DocumentTemplateSection(new DocumentTemplateCriteria(CONTACT_EMAIL, null, null), false, new DocumentTemplateReceiver(CONTACT_EMAIL)),
			new DocumentTemplateSection(
				new DocumentTemplateCriteria(EVENT_PARTICIPANT_EMAIL, null, null),
				false,
				new DocumentTemplateReceiver(EVENT_PARTICIPANT_EMAIL)),
			new DocumentTemplateSection(
				new DocumentTemplateCriteria(TRAVEL_ENTRY_EMAIL, null, null),
				false,
				new DocumentTemplateReceiver(TRAVEL_ENTRY_EMAIL)));
