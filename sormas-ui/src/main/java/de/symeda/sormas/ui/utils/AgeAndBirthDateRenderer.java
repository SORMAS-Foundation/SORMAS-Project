...
public class AgeAndBirthDateRenderer extends AbstractRenderer<Object, AgeAndBirthDateDto> {
	...
	public JsonValue encode(AgeAndBirthDateDto value) {
		return encode(PersonHelper.getAgeAndBirthdateString(value.getAge(), value.getAgeType(), value.getBirthdateDD(), value.getBirthdateMM(), value.getBirthdateYYYY(), I18nProperties.getUserLanguage()), String.class);
	}
}
