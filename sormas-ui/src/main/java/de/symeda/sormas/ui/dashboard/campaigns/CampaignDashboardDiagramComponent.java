...
public class CampaignDashboardDiagramComponent extends VerticalLayout {
	...
	public CampaignDashboardDiagramComponent(CampaignDiagramDefinitionDto diagramDefinition,
		...
		// toggle options
		JavaScript.getCurrent().addFunction("changeDiagramPercentage_" + diagramDefinition.getDiagramId(),
		...
		JavaScript.getCurrent()
				.execute("Highcharts.seriesTypes.wordcloud.prototype.deriveFontSize = function(\n"
						+ "  relativeWeight\n" + ") {\n" + "  var maxFontSize = 10;\n"
...
//											totalValuesWithoutStacks ? null : series.getStack()));
						...
						hcjs.append("var options = { \n"
								...
								+ " exporting: { enabled: false },"
									...
									+ "        type: 'wordcloud',\n"
									+ "        data: [{"
									+ "name: '"+formatter.format(amount)+""+perce+"',\n"
									+ "  weight: 1,\n"
									+ "   color: '#008000'"
									+ "}]"
									+ "    }],\n"
