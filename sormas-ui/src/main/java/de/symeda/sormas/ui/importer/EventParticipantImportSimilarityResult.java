...
public class EventParticipantImportSimilarityResult {

	private final SimilarPersonDto matchingPerson;
	private final ImportSimilarityResultOption resultOption;

	public EventParticipantImportSimilarityResult(SimilarPersonDto matchingPerson, ImportSimilarityResultOption resultOption) {
