...
public class DocGenerationController {
	...
	public void showQuarantineOrderDocumentDialog(ReferenceDto referenceDto) {
		AbstractDocgenerationLayout docgenerationLayout = new QuarantineOrderLayout(referenceDto);
