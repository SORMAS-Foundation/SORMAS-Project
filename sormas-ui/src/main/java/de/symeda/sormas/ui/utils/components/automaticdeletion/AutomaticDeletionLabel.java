...
public class AutomaticDeletionLabel extends HorizontalLayout {
	...
	public AutomaticDeletionLabel(AutomaticDeletionInfoDto automaticDeletionInfoDto) {
		...
		String infoIconDesciption = String.format(
			...
			automaticDeletionInfoDto.getDeletionDate(),
			automaticDeletionInfoDto.getEndOfProcessing(),
		...
		String infoText = String.format(I18nProperties.getString(Strings.infoAutomaticDeletion), automaticDeletionInfoDto.getDeletionDate());
