...
public class EventParticipantsController {
    ...
    public EventParticipantDto createEventParticipant(
            @NotNull SormasUI ui, EventReferenceDto eventRef, Consumer<EventParticipantReferenceDto> doneConsumer) {
    ...
    public void createEventParticipant(
            @NotNull final SormasUI ui, String eventParticipantUuid, Consumer<EventParticipantReferenceDto> doneConsumer) {
    ...
    private CommitDiscardWrapperComponent<EventParticipantEditForm> createEventParticipantEditCommitWrapper(
            ...
            @NotNull EventParticipantEditForm editForm,
            Consumer<EventParticipantReferenceDto> doneConsumer) {
