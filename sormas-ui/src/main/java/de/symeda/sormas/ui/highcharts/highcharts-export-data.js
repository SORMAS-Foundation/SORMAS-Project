...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (g) {
        a(g);
        a.Highcharts = g;
        return a
    ...
    g(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"],
        ...
        function u(a, d) {
            var b = p.navigator, f = -1 < b.userAgent.indexOf("WebKit") && 0 > b.userAgent.indexOf("Chrome"),
        ...
        var v = e.doc, f = e.seriesTypes, p = e.win;
        e = c.addEvent;
        var I = c.defined, J = c.extend, E = c.find, D =
            c.fireEvent, K = c.getOptions, L = c.isNumber, w = c.pick;
        c = c.setOptions;
        var F = g.downloadURL;
        c({
            exporting: {
        ...
        e(d, "render", function () {
            this.options && this.options.exporting && this.options.exporting.showTable && !this.options.chart.forExport && !this.dataTableDiv
        });
        ...
        d.prototype.getDataRows = function (b) {
            var d = this.hasParallelCoordinates, f = this.time,
                c = this.options.exporting && this.options.exporting.csv || {}, e = this.xAxis,
                q = {}, g = [], p = [], n = [], r;
            var t = this.options.lang.exportData;
            var A = t.categoryHeader, x = t.categoryDatetimeHeader, G = function (l, d, f) {
        ...
        d.prototype.getCSV = function (a) {
            var b = "", d = this.getDataRows(), c = this.options.exporting.csv,
        ...
        d.prototype.getTable = function (a) {
            var b = '<table id="highcharts-data-table-' + this.index + '">', c = this.options,
                d = a ? (1.1).toLocaleString()[1] : ".", f = w(c.exporting.useMultiLevelHeaders, !0);
            a = this.getDataRows(f);
            var e = 0, g = f ? a.shift() : null, p = a.shift(), n = function (a, b, c, f) {
                var e = w(f, "");
                b = "text" + (b ? " " + b : "");
            ...
            for (var r = 0, t = a.length; r < t; ++r) a[r].length >
            e && (e = a[r].length);
            b += function (a, b, d) {
                var e = "<thead>", g = 0;
                d = d || b && b.length;
                ...
                if (h) {
                    for (e += "<tr>"; g < d; ++g) {
                        h = a[g];
                        var m = a[g + 1];
                        h === m ? ++k : k ? (e += n("th", "highcharts-table-topheading", 'scope="col" colspan="' + (k + 1) + '"', h), k = 0) : (h === b[g] ? c.exporting.useRowspanHeaders ? (m = 2, delete b[g]) : (m = 1, b[g] = "") : m = 1, e += n("th", "highcharts-table-topheading", 'scope="col"' + (1 < m ? ' valign="top" rowspan="' + m + '"' : ""),
                            h))
                    }
                    e += "</tr>"
                }
        ...
        d.prototype.downloadCSV = function () {
            var a = this.getCSV(!0);
            F(u(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a), this.getFilename() +
                ".csv")
        };
        ...
        n.buttons && n.buttons.contextButton.menuItems.push("separator", "downloadCSV", "downloadXLS"));
