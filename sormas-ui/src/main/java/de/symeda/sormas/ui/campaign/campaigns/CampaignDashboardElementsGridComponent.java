...
public class CampaignDashboardElementsGridComponent extends AbstractEditableGrid<CampaignDashboardElement> {
	...
	public CampaignDashboardElementsGridComponent(List<CampaignDashboardElement> savedElements,
	...
	protected Binder<CampaignDashboardElement> addColumnsBinder(List<CampaignDashboardElement> allElements) {
		...
		final Grid.Column<CampaignDashboardElement, String> diagramIdColumn = grid
		...
		final Grid.Column<CampaignDashboardElement, String> tabIdColumn = grid
				.addColumn(campaignDashboardElement -> campaignDashboardElement.getTabId())
		...
		final Grid.Column<CampaignDashboardElement, String> subTabIdColumn = grid
				.addColumn(campaignDashboardElement -> campaignDashboardElement.getSubTabId())
		...
		Grid.Column<CampaignDashboardElement, String> widthColumn = grid
				.addColumn(campaignDashboardElement -> intToString(campaignDashboardElement.getWidth()))
		...
		Grid.Column<CampaignDashboardElement, String> heightColumn = grid
				.addColumn(campaignDashboardElement -> intToString(campaignDashboardElement.getHeight()))
		...
		Grid.Column<CampaignDashboardElement, String> orderColumn = grid
				.addColumn(campaignDashboardElement -> intToString(campaignDashboardElement.getOrder()))
		...
		Grid.Column<CampaignDashboardElement, String> phaseColumn = grid
				.addColumn(campaignDashboardElement -> campaignDashboardElement.getPhase())
