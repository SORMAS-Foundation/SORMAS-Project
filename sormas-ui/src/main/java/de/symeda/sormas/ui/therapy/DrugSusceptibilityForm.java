...
public class DrugSusceptibilityForm extends AbstractEditForm<DrugSusceptibilityDto> {
    ...
    private static final String HTML_LAYOUT =
		loc(FORM_HEADING_LOC) +
			...
			+ 			fluidRowLocsCss(CssStyles.GRID_ROW_GAP_1, AZITHROMYCIN_LABEL_LOC, DrugSusceptibilityDto.AZITHROMYCIN_MIC, null,DrugSusceptibilityDto.AZITHROMYCIN_METHOD, DrugSusceptibilityDto.AZITHROMYCIN_SUSCEPTIBILITY, null)
			+ 			fluidRowLocsCss(CssStyles.GRID_ROW_GAP_1, AMPICILLIN_LABEL_LOC, DrugSusceptibilityDto.AMPICILLIN_MIC, null, DrugSusceptibilityDto.AMPICILLIN_METHOD, DrugSusceptibilityDto.AMPICILLIN_SUSCEPTIBILITY, null)
			...
			+ 			fluidRowLocsCss(CssStyles.GRID_ROW_GAP_1, CEFTAZIDIME_LABEL_LOC, DrugSusceptibilityDto.CEFTAZIDIME_MIC, null, DrugSusceptibilityDto.CEFTAZIDIME_METHOD, DrugSusceptibilityDto.CEFTAZIDIME_SUSCEPTIBILITY,null)
			+ 			fluidRowLocsCss(CssStyles.GRID_ROW_GAP_1, CEFOTAXIME_LABEL_LOC, DrugSusceptibilityDto.CEFOTAXIME_MIC, null,DrugSusceptibilityDto.CEFOTAXIME_METHOD, DrugSusceptibilityDto.CEFOTAXIME_SUSCEPTIBILITY, null)
			...
			+ 			fluidRowLocsCss(CssStyles.GRID_ROW_GAP_1, TRIMETHOPRIM_SULFAMETHOXAZOLE_LABEL_LOC, DrugSusceptibilityDto.TRIMETHOPRIM_SULFAMETHOXAZOLE_MIC, null, DrugSusceptibilityDto.TRIMETHOPRIM_SULFAMETHOXAZOLE_METHOD, DrugSusceptibilityDto.TRIMETHOPRIM_SULFAMETHOXAZOLE_SUSCEPTIBILITY, null);
    //@formatter:on
	...
	protected void addFields() {
		...
		addMicField(DrugSusceptibilityDto.AZITHROMYCIN_MIC).setInputPrompt(I18nProperties.getString(Strings.promptMicValue));
		...
		addMicField(DrugSusceptibilityDto.CEFTAZIDIME_MIC).setInputPrompt(I18nProperties.getString(Strings.promptMicValue));
		...
		addMicField(DrugSusceptibilityDto.CEFOTAXIME_MIC).setInputPrompt(I18nProperties.getString(Strings.promptMicValue));
		...
		addMicField(DrugSusceptibilityDto.AMPICILLIN_MIC).setInputPrompt(I18nProperties.getString(Strings.promptMicValue));
		...
		addMicField(DrugSusceptibilityDto.TRIMETHOPRIM_SULFAMETHOXAZOLE_MIC).setInputPrompt(I18nProperties.getString(Strings.promptMicValue));
