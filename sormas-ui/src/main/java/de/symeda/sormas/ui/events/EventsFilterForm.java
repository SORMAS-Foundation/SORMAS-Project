...
public class EventsFilterForm extends AbstractFilterForm<EventCriteria> {
    ...
    @NotNull
    private HorizontalLayout buildWeekAndDateFilter(@NotNull EventCriteria.DateType dateType) {
    ...
    private void onApplyClick(EpiWeekAndDateFilterComponent<@NotNull DateFilterOption> weekAndDateFilter, EventCriteria.DateType dateType) {
    ...
    @Override
    protected void applyDependenciesOnFieldChange(@NotNull String propertyId, Property.ValueChangeEvent event) {
        switch (propertyId) {
    ...
    @Override
    protected void applyDependenciesOnNewValue(@NotNull EventCriteria criteria) {
