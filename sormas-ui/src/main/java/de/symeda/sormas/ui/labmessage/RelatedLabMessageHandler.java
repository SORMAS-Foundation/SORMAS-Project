...
import static de.symeda.sormas.ui.labmessage.processing.LabMessageProcessingUIHelper.showEditSampleWindow;
	...
	private <T> void showCorrectionWindow(
		...
		HorizontalLayout toolbar = new HorizontalLayout(
			ButtonHelper.createIconButton(
				null,
				VaadinIcons.EYE,
				e -> ControllerProvider.getLabMessageController().showLabMessage(labMessage.getUuid(), false, null)));
