...
public class SampleGridFilterForm extends AbstractFilterForm<SampleCriteria> {
    ...
    protected String[] getMainFilterLocators() {
        return new String[]{SampleCriteria.PATHOGEN_TEST_RESULT, SampleCriteria.SPECIMEN_CONDITION, SampleCriteria.CASE_CLASSIFICATION, SampleCriteria.DISEASE, SampleCriteria.REGION, SampleCriteria.DISTRICT, SampleCriteria.LAB,
    ...
    protected Stream<Field> streamFieldsForEmptyCheck(CustomLayout layout) {
        HorizontalLayout dateFilterLayout = (HorizontalLayout) getMoreFiltersContainer().getComponent(WEEK_AND_DATE_FILTER);
        EpiWeekAndDateFilterComponent<DateFilterOption> weekAndDateFilter = (EpiWeekAndDateFilterComponent<DateFilterOption>) dateFilterLayout.getComponent(0);
