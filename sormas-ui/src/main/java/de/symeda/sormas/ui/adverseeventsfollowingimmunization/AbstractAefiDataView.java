...
public abstract class AbstractAefiDataView extends AbstractEditAllowedDetailView<AefiReferenceDto> {

	public static final String ROOT_VIEW_NAME = AefiView.VIEW_NAME;

	protected AbstractAefiDataView(String viewName) {
		super(viewName);
	}
	...
	public void refreshMenu(SubMenu menu, String params) {
		...
		setMainHeaderComponent(
			ControllerProvider.getAefiController().getAefiViewTitleLayout(getReference().getUuid(), immunizationUuid, isCreateAction));
	}
}
