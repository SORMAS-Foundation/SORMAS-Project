...
public class PrescriptionForm extends AbstractEditForm<PrescriptionDto> {
	...
	public PrescriptionForm(boolean create, UserRight editOrCreateUserRight) {
	...
	protected void addFields() {
		...
		FieldHelper.setRequiredWhen(getFieldGroup(), prescriptionTypeField, Arrays.asList(PrescriptionDto.PRESCRIPTION_DETAILS), Arrays.asList(TreatmentType.OTHER));
