...
public enum ArchiveMessages {
	...
	ADVERSE_EVENTS_FOLLOWING_IMMUNIZATION(Strings.headingArchiveAdverseEvent,
		Strings.confirmationArchiveAdverseEvent,
		null,
		Strings.messageAdverseEventArchived,
		Strings.headingDearchiveAdverseEvent,
		Strings.confirmationDearchiveAdverseEvent,
		null,
		Strings.messageAdverseEventDearchived,
		null,
		null,
		null,
		null,
		...
		null,
		null),
	ADVERSE_EVENTS_FOLLOWING_IMMUNIZATION_INVESTIGATION(Strings.headingArchiveAdverseEventInvestigation,
		Strings.confirmationArchiveAdverseEventInvestigation,
		null,
		Strings.messageAdverseEventInvestigationArchived,
		Strings.headingDearchiveAdverseEventInvestigation,
		Strings.confirmationDearchiveAdverseEventInvestigation,
		null,
		Strings.messageAdverseEventInvestigationDearchived,
		null,
		null,
		null,
		null,
	...
	SELF_REPORT(Strings.headingArchiveSelfReport,
		Strings.confirmationArchiveSelfReport,
		null,
		Strings.messageSelfReportArchived,
		Strings.headingDearchiveSelfReport,
		Strings.confirmationDearchiveSelfReport,
		null,
		Strings.messageSelfReportDearchived,
		Strings.headingNoSelfReportsSelected,
		Strings.messageNoSelfReportsSelected,
		null,
		null,
		null,
		null,
