...
/**
 * Concrete {@link CustomizableFieldInput} for {@link de.symeda.sormas.api.customizablefield.CustomizableFieldType#NUMBER}.
 * <p>
 * Renders a Vaadin v8 {@link TextField} restricted to whole-number input via a
 ...
 */
public class CustomizableFieldInputNumber extends CustomizableFieldInput<String> {
	...
	public CustomizableFieldInputNumber(CustomizableFieldMetadataDto metadata) {
		super(metadata);
	}
	...
	protected Binder.BindingBuilder<CustomizableFieldValueDto, String> configureBinding(
		...
		return builder.withValidator(
			value -> value == null || value.isEmpty() || value.matches(INTEGER_PATTERN),
			I18nProperties.getValidationError(Validations.onlyIntegerNumbersAllowed, getFieldMetadata().getName()));
	}
