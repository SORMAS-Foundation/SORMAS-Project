...
public class ContactPersonView extends AbstractContactView {
    ...
    public void enter(ViewChangeEvent event) {
    	...
    	setSubComponent(ControllerProvider.getPersonController().getPersonEditComponent(dto.getPerson().getUuid(), caseDto.getDisease(), caseDto.getDiseaseDetails(), UserRight.CONTACT_EDIT, null));
    }
}
