			...
			+ LayoutUtil.fluidRow(
					...
					LayoutUtil.fluidColumn(6,  0, 
							LayoutUtil.locsCss(CssStyles.VSPACE3,
									...
									SymptomsDto.SHOCK, SymptomsDto.HICCUPS, SymptomsDto.BACKACHE, SymptomsDto.EYES_BLEEDING,
									SymptomsDto.JAUNDICE, SymptomsDto.DARK_URINE, SymptomsDto.STOMACH_BLEEDING, SymptomsDto.RAPID_BREATHING,
									SymptomsDto.SWOLLEN_GLANDS)
							+ LayoutUtil.locsCss(CssStyles.VSPACE3,
