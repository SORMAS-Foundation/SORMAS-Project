...
public class SurveyEmailTemplateReceiver extends DocumentTemplateReceiver {

	public final SurveyReferenceDto surveyReference;

	public SurveyEmailTemplateReceiver(DocumentWorkflow documentWorkflow, SurveyReferenceDto surveyReference) {
